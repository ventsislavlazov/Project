...
<div id = "success">		
	<c:if test="${not empty success}">
		...
		<table name = "table" border="1" id = "tableId">
			...
			<c:forEach items="${allAdmins}" var="record">
				 		<tr>
				 			...
				 			<td align="center">
					 			<form action = "./DeleteAdminFromDBServlet" method = "POST">
					 				<input type = "hidden" name = "admin" value = "${record.id}">
					 				<input type = "submit" value = "delete admin &quot;${record.username}&quot">
					 			</form>
				 			</td>
				 		</tr>
			 	</c:forEach>
