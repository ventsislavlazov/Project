...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
	...
	li button, li a{
		...
		.container a:hover, .control button:hover  {
		    background-color: red;
		}
		...
		.control-content a input{
			 background-color: inherit;
			 border: none;
		}
		
		.control-content form a:hover{
			background-color: #d9d9d9;
		}
		
		.control:hover .control-content {
		    display: block;
		}
...
<div id = "error">		
	...
	<ul class="container">
		  ...
		  <li class = "control">
		  	 <button class = "controlButton" onclick="controlFunction()">control users</button>
		  	 <div class = "control-content" id = "controlDropdownId">
			  	 <form action = "MakeUserToAdminServlet" method = "GET">
			      	<a><input type='submit' value = "Make user admin"></a> 
			      </form>
			      <form action = "MakeAdminToUserServlet" method = "GET">
			      	<a><input type='submit' value = "Make admin user"></a> 
			      </form>
			      <form action = "DeleteAdminFromDBServlet" method = "GET">
			      	<a><input type='submit' value = "Delete admins registration"></a> 
			      </form>
			      <form action = "DeleteUserFromDBServlet" method = "GET">
			      	<a><input type='submit' value = "Delete users registration"></a> 
			      </form>
		  	 </div>
		  </li>
		  ...
		  <!-- <li class = "back">
		  	<form action = "MainPageServlet" method = "GET">
			   <a><input type="submit" value = "Log out" style = "background-color:#3366ff; color:#6600cc;
	...
	/* When the user clicks on the button, 
		...
		/* function functionStatistics(){
			document.getElementById("dropdownStatisticsId").classList.toggle("show");
		}
